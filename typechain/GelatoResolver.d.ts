...
interface GelatoResolverInterface extends Interface {
  functions: {
...
export class GelatoResolver extends Contract {
  connect(signerOrProvider: Signer | Provider | string): GelatoResolver;
  attach(addressOrName: string): GelatoResolver;
  deployed(): Promise<GelatoResolver>;

  on(event: EventFilter | string, listener: Listener): GelatoResolver;
  once(event: EventFilter | string, listener: Listener): GelatoResolver;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): GelatoResolver;
  removeAllListeners(eventName: EventFilter | string): GelatoResolver;
  removeListener(eventName: any, listener: Listener): GelatoResolver;
