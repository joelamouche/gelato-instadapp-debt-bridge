...
exports.sendDSA = void 0;
var ethers_1 = require("ethers");
function sendDSA(web3, dsaAddress, eth_amount) {
    return __awaiter(this, void 0, void 0, function () {
        var provider, userWallet, gasLimit, gasPrice;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, userWallet.sendTransaction({
                            to: dsaAddress,
                            value: ethers_1.utils.parseEther(eth_amount.toString()),
                            gasLimit: gasLimit,
                            gasPrice: gasPrice,
                        })];
...
exports.sendDSA = sendDSA;
//# sourceMappingURL=sendDSA.js.map